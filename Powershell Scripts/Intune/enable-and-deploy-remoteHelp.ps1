...
<#
.SYNOPSIS
  Enables RemoteHelp, grabs the latest installer, packages and deploys including AAD Groups
.DESCRIPTION
.Enables RemoteHelp on the tenant (Thanks to Aresh Sarkari)
.Downloads latest version of RemoteHelp
.Creates Intunewin
.Creates AAD Groups
...
function new-detectionscriptinstall {
    ...
    $detection = @"
    `$File = "C:\Program Files\Remote Help\RemoteHelp.exe"
    if (Test-Path `$File) {
        write-output "RemoteHelp detected, exiting"
        exit 0
    }
    else {
        exit 1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB59+lx7yIVefdN
# SuxGPQY2Yo60ogCxrIsb4s0ptOdxhqCCIRwwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# gjcCARUwLwYJKoZIhvcNAQkEMSIEIPYsknFE3ge00P8iLLfHKR+Omh25v9eYUlVw
# MLOpBWmBMA0GCSqGSIb3DQEBAQUABIICAMC0Kb0q8dCLqnbxz9+woxe/p9VKoYT3
# VfTUtFVRsAewFfmOUmhSv2y34X5RyKR8V2Ueex09DFPQYyOSs2rKwFGTuP+GCMQ7
# BLlO5JxwaccZE11kIQvuZASqHJ3pEHhJpNpzeuNh4v3eeaXU7ZYqcNwv7KpeS0kF
# 2a1S743javgvc9O2kNLBTyqb2s8zy/Xc95PRycRdxGtYIK7i381vEVXW+BnQi8FC
# rLgwVPTRDyNa4FfowHdQqZAjYdDmKhfVwBRidWKk5vk6nmcrygp8gAZt72/5F4Ti
# 6NUi+O8c1ie/epnaxE9Eorr0aOIDVxCXeISnC/DdKzQ4aBtlwgaGNTcK5HvEWJmh
# 4kt2Pr6n7fyFjwnZQ7F6MlSRKPE2dUlfpUMtbWl+rpN8cs4sM9FxBKKlSnMEsaf7
# U64mGbvdVuzpQPkDMkL8A6bFWcUa4d6rnO3ETjOcxyHHonklnMJPi7LP+WQfaI3g
# su8vSuyKPNDDbe84c82ldiz6HxRRM1VnpqeE2InrJpOV2LcsC+fyyPCOtkGToz/J
# CciSVeMRVd42O9de+BBLyaOmUKWVKjl0u0yCeKfFlhkDRrEjNs/VehhPeDg9kSFR
# A0PJCM4zCugzhY+cC+9pBFQSopenRaHLUgIJUyzoPPwtXFsccG1D7QKvieNU1pn8
# dsz4+sJj8QxroYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkG
# A1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJbmMuMTswOQYDVQQDEzJEaWdp
# Q2VydCBUcnVzdGVkIEc0IFJTQTQwOTYgU0hBMjU2IFRpbWVTdGFtcGluZyBDQQIQ
# BUSv85SdCDmmv9s/X+VhFjANBglghkgBZQMEAgEFAKBpMBgGCSqGSIb3DQEJAzEL
# BgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIzMTExNTIwNDcyMVowLwYJKoZI
# hvcNAQkEMSIEIKf6xVBlh9lsRGOW4zJ+AW1YKogSIMdz+YR3/hq2ETEXMA0GCSqG
# SIb3DQEBAQUABIICAItj0fMHIUPLVa85CDBTgbmRo3YHnKOFst7nBSqnGD74MNEP
# eNrGFXGvvXilodkv9XDfKtSeYObDL3w9CE43nkxYIL+XUWFzvwx+1i2r9xodt78T
# XZRD2zIBSl301Fyax37k/DjCWfyTBsrQCqUgc8ciE6ukC9caHqFVebCzU9mmSTVO
# x2hTuAu9sojUToaFQY7NcW/LrfXdBH3viRxjeQASX1bozI9yvwSODpPVDQkmANYm
# gO6Da40JZ0VcklCZaKTQcarVfN7NSz7N9vGiFOwGhZa9IcbWZy0Xu2n5o3bskkk+
# gqLt432RobUtoxZsrNPKV4Bk9rZciMPi4+O7kxzW5qWeQpISzMPzP3+K6F8M2uhv
# i8S4G7FRX7IMy4YKOdb2ln3h1v4TAaEzV+1qeX/ufK4IU2B+zcrkbCIt/Nrtc7i3
# 2euWyNF2H2LUB4EQNY8ipen7lQJPIlvw39IKKRwSZ90BTebQ2ZgAvphh4h8l3iPP
# JzNAX//0BkcO+1T+DNN0eBahiVwXGSTSyTQw5eaQrBQOJCYPa7DtAL2PNdMk0TQZ
# E5B4a0mKnn2QPu+lMiOd6WGSYxSEDp511JLwEkl7oGa19i7UZndFALRgYWTydcz7
# 7mjgvYHtyk1LbxnYEbljKBYrcd8F4U9fjUyUXezNwJfi2MfZbrR1xeXsiv7d
