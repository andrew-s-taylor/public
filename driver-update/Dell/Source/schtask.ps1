...
#Set the action
$action = New-ScheduledTaskAction -Execute '"C:\Program Files (x86)\Dell\CommandUpdate\dcu-cli.exe" /applyUpdates -silent -reboot=disable -outputlog="c:\driversupd\log.log"'
